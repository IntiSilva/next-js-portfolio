  ...
  return (
    <div className="relative flex items-center justify-center h-full w-full shadow-xl shadow-black rounded-xl group hover:bg-gradient-to-r from-[#023C2B] to-[#25F8BD] ease-in duration-300">
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <h3 className="text-xl [@media(min-width:410px)]:text-2xl text-white tracking-wider text-center">
          {title}
        </h3>
        <p className="pb-4 pt-2 text-sm [@media(min-width:410px)]:text-base text-white text-center">{mainTech}</p>
